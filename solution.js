...
****************************************************/
var movieQueue=["BatmanvSuperman","Spiderman"];
...
****************************************************/
function addMovieToEnd(BatmanvSuperman){
  movieQueue.push(BatmanvSuperman);
  return BatmanvSuperman;
}
...
- Finally it should return the movie name it just added
****************************************************/
function addMovieToFront(Spiderman){
  movieQueue.unshift (Spiderman);
  return Spiderman;
}
...
- Finally it should return the movie name it just added
****************************************************/
function changeMovie(index,Agent47){
  movieQueue[index]=Agent47;
  return Agent47;
}
...
****************************************************/
function getMovie(one){
  return movieQueue[one];
}
